...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 ${isOpen ? 'bg-white shadow-xl' : 'bg-white/90 backdrop-blur-md'} border-b border-gray-100 transition-all duration-300`}>
